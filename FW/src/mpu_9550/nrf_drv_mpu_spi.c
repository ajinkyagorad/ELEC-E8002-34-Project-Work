...
#define MPU_SPI_SCL_PIN     27  // MPU SCLK. 'SCL' on MPU breakout board silk screen
#define MPU_SPI_CS_PIN      23 // MPU nCS. 'NCS' on MPU breakout board silk screen
#else // If PCA10028
